'''
    Code used to train our CNN Q-Learning agent
    Code taken from https://github.com/bchao1/Breakout-Deep-Q-Learning
'''
...
class DQNAgent:
    def __init__(self, action_size):
        ...
        if self.load_model:
            self.model.load_weights("./plot_CNN/models/model.ckpt")
    ...
    def save_model(self):
        torch.save(self.model.state_dict(), './plot_CNN/models/model.ckpt')
    ...
    def log_and_reset(self):
        ...
        np.save('./plot_CNN/logs/q_log.npy', np.array(self.q_log, dtype = np.float))
        np.save('./plot_CNN/logs/loss_log.npy', np.array(self.loss_log, dtype = np.float))
        np.save('./plot_CNN/logs/unclipped_log.npy', np.array(self.unclipped_log, dtype = np.float))
        np.save('./plot_CNN/logs/clipped_log.npy', np.array(self.clipped_log, dtype = np.float))
